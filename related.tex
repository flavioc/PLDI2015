...
which is embbeded into another language, Delirium actually embeds operators
...
Datalog-like language for programming distributed emsembles of modular robots.
...
underlying system that the program is running on and action facs act on that
system.
