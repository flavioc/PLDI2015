Here we add coordination to the SSSP program described in Section
...
\begin{topfig}
   ...
   \end{center}
   \scap{results:sssp_uspowergrid}{Experimental results for the SSSP program using US power grid network.
